...
import Page from "../site/Pages/Auth/Login";
import fixture from "../__fixtures__/auth-login.json";

/**
 * Component test for `Auth/Login`.
 *
 * Props come from __fixtures__/auth-login.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/auth-login.json');
 *
...
describe.skipIf(pending)("Auth/Login", () => {
